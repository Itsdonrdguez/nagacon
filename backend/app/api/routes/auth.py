...
def _clear_session_cookie(response: Response) -> None:
    ...
    response.delete_cookie(key=CSRF_COOKIE_NAME, path="/", httponly=False, samesite=same_site, domain=cookie_domain)
...
def signup(
    ...
    if not bool(getattr(settings, "SIGNUP_ENABLED", True)):
